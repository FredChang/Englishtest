...
# Grids that have been identified as having text contamination
CONTAMINATED_GRIDS = ["23", "24", "32", "39", "40", "41", "58"]
LEGACY_WORDS_TO_PURGE = ["bottle", "cook"]
...
def main():
    ...
    for w in LEGACY_WORDS_TO_PURGE:
        purge_words.add(w.lower().strip())
